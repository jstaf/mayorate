...
public class DamageUtilsTest {
  ...
  public void testGetDamageAtHitStrengthHighArmor() {
    ...
    final float modifiedDamage = DamageUtils.getDamageAtHitStrength(baseDamage, DamageType.ENERGY, strength, armor);
  ...
  public void testGetDamageAtHitStrengthHeDamage() {
    ...
    final float modifiedDamage = DamageUtils.getDamageAtHitStrength(baseDamage, DamageType.HIGH_EXPLOSIVE, strength,
        armor);
  ...
  public void testGetDamageAtHitStrengthKineticDamage() {
    ...
    final float strength = 100;
    final float armor = 50;
    final float modifiedDamage = DamageUtils.getDamageAtHitStrength(baseDamage, DamageType.KINETIC, strength, armor);
