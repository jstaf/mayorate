...
// An autofire plugin for the Thermal Lance as a built-in weapon. Does not aim, 
// just decides whether to fire.
public class ThermalLanceAI implements AutofireAIPlugin {
  ...
  public ThermalLanceAI(WeaponAPI weapon) {
    this.weapon = weapon;
    ship = weapon.getShip();
