...
public class CommissionEffects implements EveryFrameScript {

  private boolean hasRun = false;
  FactionAPI player;

  public CommissionEffects() {
    Global.getLogger(CommissionEffects.class).setLevel(Level.DEBUG);
  ...
  private void logKeys(Collection<String> toDump, String label) {
    for (String key : toDump) {
      Global.getLogger(CommissionEffects.class).log(Level.DEBUG, label + "key: " + key);
    }
  }
}
