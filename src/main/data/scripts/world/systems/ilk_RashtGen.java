...
public class ilk_RashtGen implements SectorGeneratorPlugin {
  ...
  public void generate(SectorAPI sector) {
    ...
    PlanetAPI ilk2 =
        system.addPlanet("inir", star, "Inir", "rocky_metallic", 330f, 120f, 1000f, 30f);
    ...
    system.addRingBand(
        star, "terrain", "rings4", 512f, 2, new Color(65, 47, 42), 512f, 1850f, 280f);
    ...
    PlanetAPI ilk1 =
        system.addPlanet("ilkhanna", star, "Ilkhanna", "ilk_ilkhanna", 185, 175, 4200, 200);
    ...
    // create jump point
    JumpPointAPI jumpPoint =
        Global.getFactory().createJumpPoint("ilk_jump_alpha", "Ilkhanna Jump Point");
    ...
    PlanetAPI ilk3 =
        system.addPlanet("sindral", star, "Sindral", "rocky_ice", 20f, 90f, 6200f, 275f);
    ...
    PlanetAPI ilk4_4 =
        system.addPlanet("amaru", ilk4, "Amaru", "cryovolcanic", 330f, 50f, 800f, 50f);
    ...
    if (!MayorateModPlugin.getIsExerelin()) {
      ...
      // start occasional bounties against mayorate enemies so players can more easily level up
      // their mayorate rep
      sector.addScript(new ilk_BountySpawner(sector, system, ilk1.getMarket(), 180f));

      // add forgiveness script to avoid rep decay on mayorate commission from being hostile with
      // pirates
