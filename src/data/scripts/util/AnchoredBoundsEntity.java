...
public class AnchoredBoundsEntity extends AnchoredEntity {
  ...
  /**
   * Creates a {@code CombatEntityAPI} that follows and rotates with another anchoring {@code
   * CombatEntityAPI}. Only difference is this entity has actual bounds and collision radius.
   *
